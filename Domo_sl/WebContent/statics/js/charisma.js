...
//			result = result + "<li><a class=\"ajax-link\" style=\"cursor:pointer;\" href=\"/springmvcproject"+json[i].subMenus[j].funcUrl+"\"><i class="+pic+"></i><span class=\"hidden-tablet\">"+json[i].subMenus[j].functionName + "</span></a></li>";
			result = result + "<li><a class=\"ajax-link\" style=\"cursor:pointer;\" href=/\springmvcproject"+json[i].subMenus[j].funcUrl+"\><i class="+pic+"></i><span class=\"hidden-tablet\">"+json[i].subMenus[j].functionName + "\</span></a></li>";
		}
		result = result +"</ul></li>";
	}
