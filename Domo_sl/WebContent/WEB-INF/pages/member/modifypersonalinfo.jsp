...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="${pageContext.request.contextPath }/Member/modifypersonalinfo.html">修改本人资料</a></li>
	</ul>
</div>
			<div class="row-fluid sortable">		
				...
				<form action="${pageContext.request.contextPath }/Member/savepersonalinfo.html" enctype="multipart/form-data" method="post" onsubmit="return modifyPersonalInfoFunc();">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/modifypersonalinfo.js"></script> 
