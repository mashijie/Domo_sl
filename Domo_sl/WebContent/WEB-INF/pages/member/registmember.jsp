...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="${pageContext.request.contextPath }/Member/registmember">会员注册</a></li>
	</ul>
</div>
			<div class="row-fluid sortable">		
				...
				<form action="${pageContext.request.contextPath }/Member/saveregistmember" enctype="multipart/form-data" method="post" onsubmit="return registMemberFunc();">
...
<script type="text/javascript" src="/Domo_sl/statics/localjs/registmember.js"></script> 