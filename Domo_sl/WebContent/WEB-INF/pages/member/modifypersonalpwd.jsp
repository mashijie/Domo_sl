...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="${pageContext.request.contextPath }/member/modifypersonalpassword.html">修改本人密码</a></li>
	</ul>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/modifypersonalpwd.js"></script> 
