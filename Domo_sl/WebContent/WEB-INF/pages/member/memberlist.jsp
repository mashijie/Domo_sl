...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="${pageContext.request.contextPath }/Member/memberlist">新会员管理</a></li>
	</ul>
</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<div class="box-content">
						<form action="${pageContext.request.contextPath }/Member/memberlist" method="post">
					...
					<div class="pagination pagination-centered">
					  <ul>
					   <c:choose>
					  	...
					  	<c:otherwise>
					  	<li><a href="${pageContext.request.contextPath }/Member/memberlist?p=1&s_loginCode=${s_loginCode}&s_userName=${s_userName}" title="首页">首页</a></li>
					  	</c:otherwise>
					  </c:choose>
						...
						<c:if test="${page.pageCount!=null}">
							<c:forEach begin='1' end='${page.pageCount}' var="num">
								<li><a href="${pageContext.request.contextPath }/Member/memberlist?p=${num}&s_loginCode=${s_loginCode}&s_userName=${s_userName}" title="${num}">
								${num} </a></li>
							</c:forEach>
						</c:if>
						<c:if test="${page.pageCount !=null}">
							<c:choose>
						  	...
						  	<c:otherwise>
						  	<li><a href="${pageContext.request.contextPath }/Member/memberlist?p=${page.pageCount}&s_loginCode=${s_loginCode}&s_userName=${s_userName}" title="尾页">尾页</a></li>
						  	</c:otherwise>
						    </c:choose>
					    </c:if>
						<c:if test="${page.pageCount == null}">
	   ...
	   <div class="modal hide fade" id="modifyMemberDiv">
		<form action="${pageContext.request.contextPath }/Member/modifymember" enctype="multipart/form-data" method="post" onsubmit="return modifyMemberFunction();">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">×</button>
				<h3>修改会员信息</h3>
			</div>
			<div class="modal-body">
				...
				<input id="m_roleId" value="2" type="hidden" name="roleId"/>
				<ul class="topul">
					<li>
					  <label>角色：</label>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/memberlist.js"></script> 
