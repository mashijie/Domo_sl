...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="${pageContext.request.contextPath }/message/messagelist.html">留言管理</a></li>
	</ul>
</div>
					...
					<div class="pagination pagination-centered">
					  <ul>
					   <c:choose>
					  	...
					  	<c:otherwise>
					  	<li><a href="${pageContext.request.contextPath }/message/messagelist.html?p=1" title="首页">首页</a></li>
					  	</c:otherwise>
					   </c:choose>
						<c:if test="${page.pageCount!=null}">
							<c:forEach begin='1' end='${page.pageCount}' var="num">
								<li><a href="${pageContext.request.contextPath }/message/messagelist.html?p=${num}" title="${num}">
								${num} </a></li>
							</c:forEach>
						</c:if>
						<c:if test="${page.pageCount !=null}">
							<c:choose>
						  	...
						  	<c:otherwise>
						  	<li><a href="${pageContext.request.contextPath }/message/messagelist.html?p=${page.pageCount}" title="尾页">尾页</a></li>
						  	</c:otherwise>
						    </c:choose>
					    </c:if>
						<c:if test="${page.pageCount == null}">
	 ...
	 <div class="modal hide fade" id="replyMessageDiv">
			...
			<ul id="replylist"></ul>
			<form action="${pageContext.request.contextPath }/message/replymessage.html" enctype="multipart/form-data" method="post" onsubmit="return replyMessageFunction();">
			<div class="modal-body">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/messagelist.js"></script> 
