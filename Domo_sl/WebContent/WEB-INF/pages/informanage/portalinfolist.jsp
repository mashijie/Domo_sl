...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="${pageContext.request.contextPath }/informanage/portalinfoList.html">资讯列表</a></li>
	</ul>
</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <c:forEach items="${page.items}" var="infor">
							<tr>
								...
								<td class="center"><a href="${pageContext.request.contextPath }/informanage/portalInfoDetail.html?id=${infor.id}">${infor.title}</a></td>
					...
					<div class="pagination pagination-centered">
					  <ul>
					   <c:choose>
					  	...
					  	<c:otherwise>
					  	<li><a href="${pageContext.request.contextPath }/informanage/portalinfoList?p=1" title="首页">首页</a></li>
					  	</c:otherwise>
					   </c:choose>
						<c:if test="${page.pageCount!=null}">
							<c:forEach begin='1' end='${page.pageCount}' var="num">
								<li><a href="${pageContext.request.contextPath }/informanage/portalinfoList?p=${num}"
...
<%-- 								<li><a href="${pageContext.request.contextPath }/informanage/portalinfoList.html?p=${num}&k=${k}" title="${num}"> --%>
<%-- 								${num} </a></li> --%>
<%-- 							</c:forEach> --%>
<%-- 						</c:if> --%>
						<c:if test="${page.pageCount !=null}">
							<c:choose>
						  	...
						  	<c:otherwise>
						  	<li><a href="${pageContext.request.contextPath }/informanage/portalinfoList?p=${page.pageCount}" title="尾页">尾页</a></li>
						  	</c:otherwise>
						    </c:choose>
					    </c:if>
						<c:if test="${page.pageCount == null}">
