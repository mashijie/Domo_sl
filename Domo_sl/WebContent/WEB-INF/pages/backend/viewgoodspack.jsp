...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="${pageContext.request.contextPath }/backend/viewgoodspack.html">查看商品套餐</a></li>
	</ul>
</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/viewgoodspack.js"></script> 
