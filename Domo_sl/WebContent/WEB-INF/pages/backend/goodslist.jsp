...
<body>
	...
	<form action="${pageContext.request.contextPath }/backend/goodslist.html" method="post">
		...
		<ul>
			<c:forEach items="${goodsInfoList}" var="goodsInfo">
				<li>
					...
					<label class="add" gid="${goodsInfo.id}" gname="${goodsInfo.goodsName}" rprice="${goodsInfo.realPrice}"><img src="${pageContext.request.contextPath }/statics/img/+.png" width="24px;"/></label>
