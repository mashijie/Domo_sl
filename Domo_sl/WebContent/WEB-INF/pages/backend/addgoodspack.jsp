...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="${pageContext.request.contextPath }/backend/addgoodspack.html">添加商品套餐</a></li>
	</ul>
</div>
			...
			<legend>添加商品套餐</legend>
                 <form action="${pageContext.request.contextPath }/GoodSpack/saveAddGoodsPack" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return addGoodsPackFunc();">
