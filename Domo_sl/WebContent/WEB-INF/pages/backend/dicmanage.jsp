				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <li class="addDicBtn">
						  		<img src="${pageContext.request.contextPath }/statics/img/ico7.png"/>
						  </li>
						  <c:forEach items="${dataList}" var="dl">
						  	<li class="maintitle">
						  		...
						  		<span class="mainset">
									<img class="modifyMainDic" dictypename="${dl.typeName}" dicid="${dl.id}" dictypecode="${dl.typeCode}" src="${pageContext.request.contextPath }/statics/img/ico10.png"> <img class="delMainDic" dictypecode="${dl.typeCode}" dictypename="${dl.typeName}" src="${pageContext.request.contextPath }/statics/img/linkdel.png">
								</span>
						  	</li>
						  </c:forEach>
						  <li class="addDicBtn">
