...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="${pageContext.request.contextPath }/backend/modifygoodspack.html">修改商品套餐</a></li>
	</ul>
</div>
			...
			<legend>修改商品套餐</legend>
                 <form action="${pageContext.request.contextPath }/GoodSpack/savemodifygoodspack" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return modifyGoodsPackFunc();">
					...
					<div class="control-group">
					  ...
					  <div class="controls">
						<ul class="aboutproductsList">
						  	<li><iframe id="goodsListFrame" class="goodsListFrame" src="${pageContext.request.contextPath }/pages/backend/goodslist.jsp"></iframe></li>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/localjs/modifygoodspack.js"></script> 
